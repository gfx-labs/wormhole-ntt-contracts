...
contract NttManager is INttManager, RateLimiter, ManagerBase {
    ...
    constructor(address _token, Mode _mode, uint16 _chainId, uint64 _rateLimitDuration, bool _skipRateLimiting)
    ...
    function _handleTransfer(
        ...
        bool enqueued =
            _enqueueOrConsumeInboundRateLimit(digest, sourceChainId, nativeTransferAmount, transferRecipient);
    ...
    function _transfer(
        ...
        TransceiverStructs.NativeTokenTransfer memory ntt =
            _prepareNativeTokenTransfer(amount, recipient, recipientChain, seq, sender, refundAddress);
    ...
    function _mintOrUnlockToRecipient(bytes32 digest, address recipient, TrimmedAmount amount, bool cancelled)
        internal
    {
        // verify chain has not forked
        checkFork(evmChainId);
