...
contract NttFactoryTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy factory
        factory = new NttFactory(VERSION, OWNER);

        vm.startBroadcast(OWNER);
        factory.setNttManagerBytecode(mockManagerBytecode);
        factory.setWhTransceiverBytecode(mockTransceiverBytecode);
        factory.setWhAddresses(envParams);
        vm.stopBroadcast();
    ...
    function test_setPeersAfterDeploy() public {
        ...
        (address token, address manager, address transceiver, address ownerContract) =
